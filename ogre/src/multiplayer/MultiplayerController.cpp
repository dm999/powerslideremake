...
bool MultiplayerController::saySessionReadyMaster(const std::vector<std::string>& aiSkins, const std::string& playerCharacter)
{
...
bool MultiplayerController::saySessionReadySlave(const std::string& playerCharacter)
{
