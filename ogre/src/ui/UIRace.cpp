...
void UIRace::load(  CustomTrayManager* trayMgr, const GameState& gameState)
{
    ...
    //cheats
    {
        ...
        {
            std::vector<Ogre::String> texName;
            texName.push_back("OriginalCheatHover");
            Ogre::MaterialPtr newMat = CloneMaterial("Test/CheatHover",
                "Test/Diffuse",
                texName,
                1.0f,
                TEMP_RESOURCE_GROUP_NAME);
...
void UIRace::setVisibleCheat(bool isVisible, InputKeyMapping cheat)
{
    if(isVisible)
    {
        ...
        if(cheat == InputKeyMapping::kmHover) mPanelSticky->setMaterialName("Test/CheatHover");
...
void UIRace::loadMisc(const GameState& gameState, const PFLoader& pfLoaderData, const PFLoader& pfLoaderGameshell)
{
...
#if defined(__ANDROID__)
        TEXLoader().load(gameState.getPFLoaderData(), "data/misc/cheats", "blast_m_4.tex", "OriginalCheatBlast", gameState.getX2LUTs(), gameState.getX4LUTs(), TEMP_RESOURCE_GROUP_NAME);
        TEXLoader().load(gameState.getPFLoaderData(), "data/misc/cheats", "light_m_4.tex", "OriginalCheatLight", gameState.getX2LUTs(), gameState.getX4LUTs(), TEMP_RESOURCE_GROUP_NAME);
#endif

    TEXLoader().load(gameState.getPFLoaderData(), "data/misc/cheats", "sticky_m_4.tex", "OriginalCheatSticky", gameState.getX2LUTs(), gameState.getX4LUTs(), TEMP_RESOURCE_GROUP_NAME);
    TEXLoader().load(gameState.getPFLoaderData(), "data/misc/cheats", "spider_m_4.tex", "OriginalCheatSpider", gameState.getX2LUTs(), gameState.getX4LUTs(), TEMP_RESOURCE_GROUP_NAME);
    TEXLoader().load(gameState.getPFLoaderData(), "data/misc/cheats", "icbm_m_4.tex", "OriginalCheatICBM", gameState.getX2LUTs(), gameState.getX4LUTs(), TEMP_RESOURCE_GROUP_NAME);
    TEXLoader().load(gameState.getPFLoaderData(), "data/misc/cheats", "apollo_m_4.tex", "OriginalCheatApollo", gameState.getX2LUTs(), gameState.getX4LUTs(), TEMP_RESOURCE_GROUP_NAME);
    TEXLoader().load(gameState.getPFLoaderData(), "data/misc/cheats", "lunar_m_4.tex", "OriginalCheatLunar", gameState.getX2LUTs(), gameState.getX4LUTs(), TEMP_RESOURCE_GROUP_NAME);
    TEXLoader().load(gameState.getPFLoaderData(), "data/misc/cheats", "jump_m_4.tex", "OriginalCheatJump", gameState.getX2LUTs(), gameState.getX4LUTs(), TEMP_RESOURCE_GROUP_NAME);
    TEXLoader().load(gameState.getPFLoaderData(), "data/misc/cheats", "hover_m_4.tex", "OriginalCheatHover", gameState.getX2LUTs(), gameState.getX4LUTs(), TEMP_RESOURCE_GROUP_NAME);
    TEXLoader().load(gameState.getPFLoaderData(), "data/misc/cheats", "glider_m_4.tex", "OriginalCheatGlider", gameState.getX2LUTs(), gameState.getX4LUTs(), TEMP_RESOURCE_GROUP_NAME);

    TEXLoader().load(gameState.getPFLoaderData(), "data/misc/startlights", "ready_left_m_2.tex", "OriginalStartReadyL", gameState.getX2LUTs(), gameState.getX4LUTs(), TEMP_RESOURCE_GROUP_NAME);
    TEXLoader().load(gameState.getPFLoaderData(), "data/misc/startlights", "ready_centre_m_2.tex", "OriginalStartReadyC", gameState.getX2LUTs(), gameState.getX4LUTs(), TEMP_RESOURCE_GROUP_NAME);
    TEXLoader().load(gameState.getPFLoaderData(), "data/misc/startlights", "ready_right_m_2.tex", "OriginalStartReadyR", gameState.getX2LUTs(), gameState.getX4LUTs(), TEMP_RESOURCE_GROUP_NAME);

    TEXLoader().load(gameState.getPFLoaderData(), "data/misc/startlights", "set_left_m_2.tex", "OriginalStartSetL", gameState.getX2LUTs(), gameState.getX4LUTs(), TEMP_RESOURCE_GROUP_NAME);
    TEXLoader().load(gameState.getPFLoaderData(), "data/misc/startlights", "ready_centre_m_2.tex", "OriginalStartSetC", gameState.getX2LUTs(), gameState.getX4LUTs(), TEMP_RESOURCE_GROUP_NAME);
    TEXLoader().load(gameState.getPFLoaderData(), "data/misc/startlights", "set_right_m_2.tex", "OriginalStartSetR", gameState.getX2LUTs(), gameState.getX4LUTs(), TEMP_RESOURCE_GROUP_NAME);

    TEXLoader().load(gameState.getPFLoaderData(), "data/misc/startlights", "go_left_m_2.tex", "OriginalStartGoL", gameState.getX2LUTs(), gameState.getX4LUTs(), TEMP_RESOURCE_GROUP_NAME);
    TEXLoader().load(gameState.getPFLoaderData(), "data/misc/startlights", "go_centre_m_2.tex", "OriginalStartGoC", gameState.getX2LUTs(), gameState.getX4LUTs(), TEMP_RESOURCE_GROUP_NAME);
    TEXLoader().load(gameState.getPFLoaderData(), "data/misc/startlights", "go_right_m_2.tex", "OriginalStartGoR", gameState.getX2LUTs(), gameState.getX4LUTs(), TEMP_RESOURCE_GROUP_NAME);
    ...
    //dashboard position
    {
        ...
        TEXLoader().load(gameState.getPFLoaderData(), "data/misc/dashes", dashPositionTexture, "OriginalDashPosition", gameState.getX2LUTs(), gameState.getX4LUTs(), TEMP_RESOURCE_GROUP_NAME);
    }
    ...
    //tacho
    {
        ...
        TEXLoader().load(gameState.getPFLoaderData(), "data/misc/tachos", tachoTexture, "OriginalTacho", gameState.getX2LUTs(), gameState.getX4LUTs(), TEMP_RESOURCE_GROUP_NAME);
    ...
    TEXLoader().load(gameState.getPFLoaderData(), "data/misc", "font_set_1_m_1.tex", "OriginalFont", gameState.getX2LUTs(), gameState.getX4LUTs(), TEMP_RESOURCE_GROUP_NAME);
    ...
    TEXLoader().load( pfLoaderData, 
                                "data/misc", "1_m_1.tex", 
                                "OriginalFinished1", gameState.getX2LUTs(), gameState.getX4LUTs(), TEMP_RESOURCE_GROUP_NAME);

    TEXLoader().load( pfLoaderData, 
                                "data/misc", "2_m_1.tex", 
                                "OriginalFinished2", gameState.getX2LUTs(), gameState.getX4LUTs(), TEMP_RESOURCE_GROUP_NAME);

    TEXLoader().load( pfLoaderData, 
                                "data/misc", "3_m_1.tex", 
                                "OriginalFinished3", gameState.getX2LUTs(), gameState.getX4LUTs(), TEMP_RESOURCE_GROUP_NAME);

    TEXLoader().load( pfLoaderData, 
                                "data/misc", "4_m_1.tex", 
                                "OriginalFinished4", gameState.getX2LUTs(), gameState.getX4LUTs(), TEMP_RESOURCE_GROUP_NAME);
