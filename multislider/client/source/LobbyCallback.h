...
namespace multislider
{
    ...
    public:
        ...
        static const uint8_t FLAG_RECONFIGURED_BY_HOST;     ///< Room has been reconfigured by host
        static const uint8_t FLAG_RECONFIGURE_FAIL;         ///< Couldn't change room parameters
