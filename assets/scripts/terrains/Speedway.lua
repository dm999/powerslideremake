function createSpeedway()
    ...
    Terrain.Scene.AI.Medium.LateralStabilization = 0.2;
    Terrain.Scene.AI.Hard = {}
    Terrain.Scene.AI.Hard.SpeedCoeff = 0.8;
    Terrain.Scene.AI.Hard.LateralStabilization = 0.2;
    Terrain.Scene.AI.Insane = {}
    Terrain.Scene.AI.Insane.SpeedCoeff = 1.2;
    Terrain.Scene.AI.Insane.LateralStabilization = 0.2;
