function createCitytrack()
    ...
    Terrain.Scene.AI.Easy.LateralStabilization = 1.2;
    ...
    Terrain.Scene.AI.Hard.LateralStabilization = 1.6;
    Terrain.Scene.AI.Insane = {}
    Terrain.Scene.AI.Insane.SpeedCoeff = 1.0;
    Terrain.Scene.AI.Insane.LateralStabilization = 1.6;
